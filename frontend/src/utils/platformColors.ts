...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'openrouter' | 'deepseek'
...
function isPlatform(p: string): p is Platform {
	return p === 'anthropic' || p === 'openai' || p === 'antigravity' || p === 'gemini' || p === 'openrouter' || p === 'deepseek'
}
