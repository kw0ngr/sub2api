...
const pOpts = computed(() => [{ value: '', label: t('admin.accounts.allPlatforms') }, { value: 'anthropic', label: 'Anthropic' }, { value: 'openai', label: 'OpenAI' }, { value: 'gemini', label: 'Gemini' }, { value: 'glm', label: 'GLM' }, { value: 'antigravity', label: 'Antigravity' }, { value: 'openrouter', label: 'OpenRouter' }, { value: 'deepseek', label: 'DeepSeek' }])
