...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'openrouter' | 'deepseek'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'openrouter' | 'deepseek'
