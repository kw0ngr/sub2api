...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'openrouter' | 'deepseek' | 'glm' | 'grok'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'openrouter' | 'deepseek' | 'glm' | 'grok'
