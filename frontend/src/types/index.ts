...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'openrouter' | 'deepseek' | 'glm'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'openrouter' | 'deepseek' | 'glm'
