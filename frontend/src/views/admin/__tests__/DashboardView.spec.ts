...
describe('admin DashboardView', () => {
  ...
  it('renders admin member insights and hourly activity widgets', async () => {
    ...
    expect(wrapper.text()).toContain('admin.dashboard.gatewayRadar')
    expect(wrapper.text()).toContain('admin.dashboard.gatewayRadarAccounts')
  ...
  it('keeps the tall member contribution card out of the nested compact insight row', async () => {
    ...
    expect(insightItems[1].text()).toContain('admin.dashboard.gatewayRadar')
  })
