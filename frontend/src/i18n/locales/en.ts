export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      rawKeyImportHint: 'Paste raw API keys and the system will auto-detect OpenAI, Anthropic, Gemini, OpenRouter, and GLM. Use deepseek,key or glm,key for explicit imports.',
