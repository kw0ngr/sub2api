          ...
          authCodePlaceholder:
            'Option 1: Copy the complete URL\n(http://localhost:xxx/auth/callback?code=...)\nOption 2: Copy only the code parameter value',
                  ...
                  grok: {
                    ...
                    refreshTokenAuth: 'Bulk Import Tokens',
                    refreshTokenDesc: 'Bulk-import xAI Refresh Tokens / Access Tokens / SSO. One per line. Use refresh_token: / access_token: / sso= prefixes; JWTs are auto-detected as access tokens.',
