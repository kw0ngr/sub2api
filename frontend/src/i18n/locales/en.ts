export default {
  ...
  admin: {
    ...
    dashboard: {
      ...
      accounts: 'Accounts',
      grokPool: 'Grok Pool',
      grokPoolRadar: 'Gateway Radar',
      grokPoolEstimate: 'Estimated Grok pool remaining tokens',
      grokPoolFormula: '{accounts} available acct × {tokens}/acct - used in 40m',
      grokPoolReady: 'Schedulable',
      grokPoolEmpty: 'No accounts',
      grokPoolAccountsShort: 'Available',
      grokPoolPerAccountShort: 'Per acct',
      grokPoolBasis: 'Window',
      grokPoolNotice: 'Estimate = schedulable Grok accounts × local 40m per-account budget - tokens used in the last 40m; for operations only, not official live balance.',
      grokPoolAccounts: 'available accounts',
        grokPoolPerAccount: 'acct·40m',
        grokPoolHint: 'Available Grok accounts × local 40m estimate, minus tokens used by those accounts in the last 40m (unofficial)',
      users: 'Users',
      todayRequests: 'Today Requests',
      ...
      groupDistribution: 'Group Usage Distribution',
      projectDistribution: 'Project Distribution',
      userDistribution: 'Member Contribution',
      unattributedProject: 'Unattributed',
      attributionQuality: 'Attribution Quality',
      attributedShare: 'Attributed Share',
      configureProjectHint: 'Add a project label to requests to split this view by real projects.',
      usageInsights: 'Usage Insights',
      ...
      totalTeamTokens: 'Team Tokens',
      totalTeamSpend: 'Team Spend',
      memberContribution: 'Member Contribution',
      topMember: 'Top Member',
      topMemberShare: 'Top Member Share',
      otherMembers: 'Other Members',
      viewUserUsage: 'View member details',
      memberPulse: 'Member Spend Pulse',
      memberPulseHint: 'Admin accounts are excluded by default to reflect real team usage.',
      nonAdminOnly: 'No admin',
      topThreeShare: 'Top 3 Share',
      topThreeSpendShare: 'Top 3 Spend Share',
      avgTokensPerRequest: 'Avg Tokens / Req',
      avgTokensPerMember: 'Avg Tokens / Member',
      avgSpendPerRequest: 'Avg Spend / Req',
      avgSpendPerMember: 'Avg Spend / Member',
      longTailMembers: 'Long-tail Members',
      nonAdminLeaderboard: 'Non-admin Ranking',
      nonAdminSpendSummary: 'Non-admin Spend Summary',
      gatewayBrief: 'Gateway Brief',
      gatewayBriefHint: 'One card for spend, account health, cache efficiency, and fast runbook entry points.',
      gatewayBriefNeedsAttention: 'Needs attention',
      gatewayBriefWatch: 'Watching',
      gatewayBriefHealthy: 'Healthy',
      gatewayBriefSpend: 'Period Spend',
      gatewayBriefHealth: 'Account Health',
      gatewayBriefHealthOk: 'Normal',
      gatewayBriefCache: 'Cache Efficiency',
      gatewayBriefTraffic: 'Traffic',
      gatewayBriefAccounts: 'Accounts',
      gatewayBriefMonitor: 'Channel Monitor',
      gatewayBriefUsage: 'Usage Logs',
      gatewayBriefFingerprints: 'Fingerprints',
      gatewayAlertAccountIssues: 'Upstream accounts need attention',
      gatewayAlertAccountIssuesDesc: '{count} of {total} accounts are erroring, rate-limited, or overloaded. Check drain and recovery status first.',
      gatewayAlertSpendConcentration: 'Spend is concentrated',
      gatewayAlertSpendConcentrationDesc: '{member} accounts for {share} of spend in this range. Check quotas, key allocation, and unusual jobs.',
      gatewayAlertLowCache: 'Cache reuse is low',
      gatewayAlertLowCacheDesc: 'Cache share is {share}. Review common prompts, long-context reuse, and cache TTL policy.',
      gatewayAlertHealthy: 'Gateway looks healthy',
      gatewayAlertHealthyDesc: 'No obvious anomalies. Keep watching channel health and member usage trends.',
      gatewayRadar: 'Gateway Radar',
      gatewayRadarHint: 'A quick check of account availability, latency, throughput, cache reuse, and spend distribution.',
      gatewayRadarNeedsAttention: 'Needs attention',
      gatewayRadarSlow: 'Slow',
      gatewayRadarConcentrated: 'Concentrated',
      gatewayRadarStable: 'Stable',
      gatewayRadarAccounts: 'Account Availability',
      gatewayRadarLatency: 'Avg Response',
      gatewayRadarThroughput: 'Live Throughput',
      gatewayRadarCache: 'Cache Reuse',
      gatewayRadarDistribution: 'Spend Distribution',
      gatewayRadarIssues: '{count} issues',
      gatewayRadarAllNormal: 'All normal',
      gatewayRadarCheck: 'Check needed',
      gatewayRadarAcceptable: 'Acceptable',
      gatewayRadarNoRanking: 'No ranking',
      memberPulseConcentratedTitle: 'Usage is concentrated',
      memberPulseConcentratedBody: 'The top member has a high share. Check quotas and key ownership if this is unexpected.',
      memberPulseCacheTitle: 'Cache usage is strong',
      memberPulseCacheBody: 'Cache read share is high, which means repeated context is being reused effectively.',
      memberPulseSparseTitle: 'Few active members',
      memberPulseSparseBody: 'Only a few members are active in this range. Try a longer range to inspect the trend.',
      memberPulseBalancedTitle: 'Team usage is balanced',
      memberPulseBalancedBody: 'No single member dominates usage. Keep watching trend changes over time.',
      ...
      viewSpendingRanking: 'User Usage Ranking',
      spendingRankingTitle: 'User Usage Ranking',
      spendingRankingUser: 'User',
      spendingRankingRequests: 'Requests',
      spendingRankingTokens: 'Tokens',
      spendingRankingSpend: 'Actual Cost',
    ...
    accounts: {
      ...
      rawKeyImportHint: 'Paste raw API keys and the system will auto-detect OpenAI, Anthropic, Gemini, OpenRouter, GLM, and Grok. Use deepseek,key, glm,key, or grok,key for explicit imports.',
      rawKeyImportFormatHint: 'Supported formats: key, key,base_url, platform,key, or platform,key,base_url. Comment lines starting with # or // are ignored. OpenRouter/DeepSeek balance will be filled by health checks. GLM defaults to Anthropic mode; paas/v4 base_url is imported as OpenAI mode.',
      rawKeyImportLabel: 'Key List',
      rawKeyImportPlaceholder: 'sk-proj-xxx\nsk-ant-xxx,https://api.anthropic.com\nAIzaSyxxxx,https://generativelanguage.googleapis.com\nsk-or-v1-xxx\nopenrouter,sk-or-v1-xxx,https://openrouter.ai/api/v1\ndeepseek,sk-xxx\nglm,sk-xxx,https://open.bigmodel.cn/api/anthropic\ngrok,xai-xxx,https://api.x.ai/v1',
      ...
      rawKeyImportEmpty: 'Please paste the keys to import',
      rawKeyImportFailed: 'Failed to import raw keys',
      rawKeyImportResult: 'Import Result',
      rawKeyImportSummary: 'Total lines {total_lines}, created {created}, checked {checked}, valid {valid}, auto-disabled {invalid_disabled}, failed {failed}',
      rawKeyImportDetails: 'Details',
      rawKeyImportClear: 'Clear',
      rawKeyImportStatusValid: 'valid',
      ...
      apiKeyHealthCheckAll: 'Check',
      apiKeyHealthCheckAllTitle: 'Check all keys',
      apiKeyHealthCheckOne: 'Check This Key',
      apiKeyHealthChecking: 'Checking...',
      apiKeyHealthCheckStarted: 'API key health check started for {total} accounts',
      apiKeyHealthCheckAllConfirm: 'Run health checks for all supported apikey accounts now? Invalid keys will be disabled automatically.',
      apiKeyHealthCheckSelectedConfirm: 'Run health checks for {count} selected supported API key account(s) now? Invalid keys will be disabled automatically.',
      apiKeyHealthCheckOneConfirm: 'Run health check for account "{name}" now? Invalid keys will be disabled automatically.',
      apiKeyHealthCheckNoSupportedSelected: 'No supported API key account is selected',
      apiKeyHealthCheckUnsupported: 'This account is not a supported platform API key',
      apiKeyHealthCheckFailed: 'Failed to check API key health',
      apiKeyHealthCheckTimeout: 'API key health check timed out. Refresh status later or retry.',
      apiKeyHealthCheckAllResult: 'Health check completed: checked {checked}, valid {valid}',
      apiKeyHealthCheckAllResultWithIssues: 'Health check completed: checked {checked}, valid {valid}, auto-disabled {invalid_disabled}, failed {failed}',
      ...
      probeGrokQuota: 'Probe Grok Quota',
      ...
      bulkActions: {
        ...
        checkHealth: 'Check Selected Keys',
          ...
          authCodePlaceholder:
            'Option 1: Copy the complete URL\n(http://localhost:xxx/auth/callback?code=...)\nOption 2: Copy only the code parameter value',
                  ...
                  grok: {
                    ...
                    followSteps: 'Follow these steps to authorize your Grok / xAI account:',
                    step1GenerateUrl: 'Generate the authorization URL',
                    generateAuthUrl: 'Generate Auth URL',
                    step2OpenUrl: 'Open the URL in your browser and complete authorization',
                    openUrlDesc: 'Open the authorization URL in a new tab, log in to your xAI account and authorize.',
                    step3EnterCode: 'Enter Authorization URL or Code',
                    authCodeDesc: 'After authorization, copy the callback URL or code parameter and paste it below.',
                    authCode: 'Authorization URL or Code',
    ...
    scheduledTests: {
      ...
      autoRecoverHelp: 'Successful tests always clear transient cooldown state; this also recovers accounts from error status.'
    },
      ...
      alertRules: {
        ...
        metricDescriptions: {
          ...
          accountTempUnscheduledCount:
            'Number of accounts currently temporarily unschedulable (for example, proxy or credential failure auto-eviction).',
          overloadAccountCount: 'Number of overloaded accounts within the window.',
          proxyExpiredCount: 'Number of proxies currently marked as expired.',
          proxyExpiringSoonCount: 'Number of active proxies that expire within their configured warning window.'
        },
        hints: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        glmZCodeStrongMimic: 'GLM ZCode Strong Mimic',
        glmZCodeStrongMimicHint: 'Official GLM Anthropic direct requests always get a light ZCode header overlay; enabling this adds ZCode app version, platform, and OS fingerprint headers.',
        glmZCodeStrongMimicNote: 'Disabled by default. Applies only to official open.bigmodel.cn / api.z.ai direct base URLs; custom relays are not rewritten as ZCode.',
        openaiCyberSafetyRetry: 'OpenAI Cyber Safety Key Retry',
        openaiCyberSafetyRetryHint: 'When OpenAI returns a “possible cybersecurity risk / Trusted Access for Cyber” response, hide it from the client and retry with another OpenAI account.',
        openaiCyberSafetyRetryNote: 'Disabled by default. When enabled, one request switches keys at most 3 times; if all fail, a generic upstream error is returned.',
        openaiGPT56SolDefaultMax: 'GPT-5.6 Sol default Max reasoning',
        openaiGPT56SolDefaultMaxHint: 'When a client requests gpt-5.6-sol without reasoning.effort / reasoning_effort, forward it as max reasoning and record max in usage logs.',
        openaiGPT56SolDefaultMaxNote: 'Disabled by default. Enable only when your client UI selects Max but omits the reasoning field from the request body.',
