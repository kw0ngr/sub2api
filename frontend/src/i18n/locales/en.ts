export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      rawKeyImportFormatHint: 'Supported formats: one key per line, or key,base_url. Comment lines starting with # or // are ignored. Only OpenAI, Anthropic, and Gemini apikey accounts are supported in this version.',
      ...
      apiKeyHealthChecking: 'Checking... ({checked}/{total})',
      ...
      apiKeyHealthCheckAlreadyRunning: 'Health check is already running in the background',
