export default {
  ...
  admin: {
    ...
    dashboard: {
      ...
      grokPoolEstimate: 'Estimated Grok pool tokens',
      grokPoolFormula: '{accounts} available acct × {tokens}/acct · 40m',
      ...
      grokPoolNotice: 'Estimate = schedulable Grok accounts × local 40m per-account budget; for operations only, not official live balance.',
      grokPoolAccounts: 'available accounts',
        grokPoolPerAccount: 'acct·40m',
        grokPoolHint: 'Available Grok accounts × local 40m token estimate (unofficial)',
      users: 'Users',
      todayRequests: 'Today Requests',
