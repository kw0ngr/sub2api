export default {
  ...
  admin: {
    ...
    dashboard: {
      ...
      grokPoolEstimate: 'Grok 账号池粗估可用 Token',
      grokPoolFormula: '{accounts} 个可用号 × {tokens}/号 · 40m',
      grokPoolReady: '可调度',
      grokPoolEmpty: '无可用号',
      grokPoolAccountsShort: '可用号',
      grokPoolPerAccountShort: '单号估算',
      grokPoolBasis: '估算窗口',
      grokPoolNotice: '粗估值=当前可调度 Grok 账号 × 本地 40m 单号预算；用于运营判断，不代表官方实时余额。',
      grokPoolAccounts: '可用账号',
        grokPoolPerAccount: '号·40m',
        grokPoolHint: '可用 Grok 账号数 × 本地 40m 估算额度（非官方）',
      totalAccounts: '账号总数',
      activeAccounts: '活跃账号',
      todayRequests: '今日请求',
      totalRequests: '总请求数',
