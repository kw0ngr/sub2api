    ...
    accounts: {
      ...
      oauth: {
        ...
        grok: {
          ...
          tokenListLabel: 'Token 列表（RT / AT / SSO）',
          refreshTokenDesc: '支持批量导入 xAI Refresh Token / Access Token / SSO。每行一个；可用 refresh_token: / access_token: / sso= 前缀，JWT 会自动识别为 access_token。',
