export default {
  ...
  admin: {
    ...
    dashboard: {
      ...
      accounts: '账号',
      grokPool: 'Grok 账号池',
      grokPoolRadar: '网关运行雷达',
      grokPoolEstimate: 'Grok 账号池粗估剩余 Token',
      grokPoolFormula: '{accounts} 个可用号 × {tokens}/号 - 近 40m 已用',
      grokPoolReady: '可调度',
      grokPoolEmpty: '无可用号',
      grokPoolAccountsShort: '可用号',
      grokPoolPerAccountShort: '单号估算',
      grokPoolBasis: '估算窗口',
      grokPoolNotice: '粗估值=当前可调度 Grok 账号 × 本地 40m 单号预算 - 近 40m 已用 token；用于运营判断，不代表官方实时余额。',
      grokPoolAccounts: '可用账号',
        grokPoolPerAccount: '号·40m',
        grokPoolHint: '可用 Grok 账号数 × 本地 40m 估算额度，再扣除这些账号近 40m 已用 token（非官方）',
      totalAccounts: '账号总数',
      activeAccounts: '活跃账号',
      todayRequests: '今日请求',
      totalRequests: '总请求数',
      ...
      groupDistribution: '分组使用分布',
      projectDistribution: '项目分布',
      userDistribution: '成员贡献分布',
      unattributedProject: '未标记',
      attributionQuality: '项目归因质量',
      attributedShare: '已归因占比',
      configureProjectHint: '为请求添加项目标签后，这里会按真实项目拆分。',
      usageInsights: '使用洞察',
      ...
      member: '成员',
      activeMembers: '活跃成员',
      totalTeamTokens: '团队 Token',
      totalTeamSpend: '团队消费',
      memberContribution: '成员贡献',
      topMember: '最高成员',
      topMemberShare: '最高成员占比',
      otherMembers: '其他成员',
      viewUserUsage: '查看该成员明细',
      memberPulse: '成员消费看板',
      memberPulseHint: '默认剔除管理员账号，更贴近团队真实使用。',
      nonAdminOnly: '不含 admin',
      topThreeShare: 'Top 3 占比',
      topThreeSpendShare: 'Top 3 消费占比',
      avgTokensPerRequest: '单请求均值',
      avgTokensPerMember: '人均 Token',
      avgSpendPerRequest: '单请求消费',
      avgSpendPerMember: '人均消费',
      longTailMembers: '长尾成员',
      nonAdminLeaderboard: '非管理员排行',
      nonAdminSpendSummary: '非管理员消费摘要',
      gatewayBrief: '网关运营简报',
      gatewayBriefHint: '把消费、账号健康、缓存和排障入口收敛到一张卡里。',
      gatewayBriefNeedsAttention: '需关注',
      gatewayBriefWatch: '观察中',
      gatewayBriefHealthy: '运行平稳',
      gatewayBriefSpend: '本期消费',
      gatewayBriefHealth: '账号健康',
      gatewayBriefHealthOk: '正常',
      gatewayBriefCache: '缓存效率',
      gatewayBriefTraffic: '请求流量',
      gatewayBriefAccounts: '账号管理',
      gatewayBriefMonitor: '渠道监测',
      gatewayBriefUsage: '使用记录',
      gatewayBriefFingerprints: '指纹策略',
      gatewayAlertAccountIssues: '上游账号存在异常',
      gatewayAlertAccountIssuesDesc: '当前有 {count} 个账号异常 / 限流 / 过载，共 {total} 个账号，建议优先检查摘流和恢复状态。',
      gatewayAlertSpendConcentration: '成员消费集中',
      gatewayAlertSpendConcentrationDesc: '{member} 占本期消费 {share}，建议检查额度、key 分配和是否存在异常任务。',
      gatewayAlertLowCache: '缓存复用偏低',
      gatewayAlertLowCacheDesc: '当前缓存占比 {share}，可以检查常用提示词、长上下文复用和缓存 TTL 策略。',
      gatewayAlertHealthy: '运行状态健康',
      gatewayAlertHealthyDesc: '暂无明显异常，可以继续观察渠道监测和成员使用趋势。',
      gatewayRadar: '网关运行雷达',
      gatewayRadarHint: '账户、延迟、吞吐、缓存和消费集中度的快速体检。',
      gatewayRadarNeedsAttention: '需关注',
      gatewayRadarSlow: '偏慢',
      gatewayRadarConcentrated: '偏集中',
      gatewayRadarStable: '稳定',
      gatewayRadarAccounts: '账户可用性',
      gatewayRadarLatency: '平均响应',
      gatewayRadarThroughput: '实时吞吐',
      gatewayRadarCache: '缓存复用',
      gatewayRadarDistribution: '消费分散度',
      gatewayRadarIssues: '{count} 异常',
      gatewayRadarAllNormal: '全部正常',
      gatewayRadarCheck: '建议排查',
      gatewayRadarAcceptable: '可接受',
      gatewayRadarNoRanking: '暂无排行',
      memberPulseConcentratedTitle: '成员使用较集中',
      memberPulseConcentratedBody: '最高成员占比较高，建议关注配额和 key 分配是否符合团队预期。',
      memberPulseCacheTitle: '缓存利用较好',
      memberPulseCacheBody: '缓存读取占比较高，说明重复上下文复用效果明显。',
      memberPulseSparseTitle: '活跃成员偏少',
      memberPulseSparseBody: '当前时间范围内有效成员较少，可以拉长时间范围观察趋势。',
      memberPulseBalancedTitle: '团队分布较均衡',
      memberPulseBalancedBody: '成员贡献没有明显单点集中，当前分布适合继续观察趋势变化。',
      cacheCreation: '缓存写入',
      cacheRead: '缓存读取',
      topModel: '最高模型',
      topProject: '最高项目',
      ...
      viewSpendingRanking: '用户用量榜',
      spendingRankingTitle: '用户用量榜',
      spendingRankingUser: '用户',
      spendingRankingRequests: '请求',
      spendingRankingTokens: 'Token',
      spendingRankingSpend: '实际成本',
    ...
    accounts: {
      ...
      rawKeyImportHint: '粘贴原始 API Key，系统会自动识别 OpenAI、Anthropic、Gemini、OpenRouter、GLM、Grok 平台；DeepSeek/GLM/Grok 可用 deepseek,key / glm,key / grok,key 显式导入。',
      rawKeyImportFormatHint: '支持每行一个 key、key,base_url、platform,key 或 platform,key,base_url。支持 # / // 注释行。OpenRouter/DeepSeek 会在健康检查中补充余额信息；GLM 默认按 Anthropic 模式导入，paas/v4 base_url 会识别为 OpenAI 模式。',
      ...
      rawKeyImportEmpty: '请先粘贴要导入的 key',
      rawKeyImportFailed: '原始 key 导入失败',
      rawKeyImportResult: '导入结果',
      rawKeyImportSummary: '总行数 {total_lines}，创建 {created}，已检测 {checked}，有效 {valid}，自动禁用 {invalid_disabled}，失败 {failed}',
      rawKeyImportDetails: '明细',
      rawKeyImportClear: '清空重填',
      rawKeyImportStatusValid: '有效',
      ...
      apiKeyHealthCheckAll: '巡检',
      apiKeyHealthCheckAllTitle: '巡检全部 Key',
      apiKeyHealthCheckOne: '巡检此 Key',
      apiKeyHealthChecking: '巡检中...',
      apiKeyHealthCheckStarted: 'Key 巡检已开始，共 {total} 个账号',
      apiKeyHealthCheckAllConfirm: '确定立即巡检当前系统内所有受支持的 apikey 账号吗？检测到失效 key 会自动禁用。',
      apiKeyHealthCheckSelectedConfirm: '确定立即巡检选中的 {count} 个受支持 API Key 账号吗？检测到失效 key 会自动禁用。',
      apiKeyHealthCheckOneConfirm: '确定立即巡检账号“{name}”吗？检测到失效 key 会自动禁用。',
      apiKeyHealthCheckNoSupportedSelected: '选中账号里没有可巡检的 API Key 账号',
      apiKeyHealthCheckUnsupported: '该账号不是支持巡检的平台 API Key',
      apiKeyHealthCheckFailed: 'Key 巡检失败',
      apiKeyHealthCheckTimeout: 'Key 巡检超时，请稍后刷新状态或重试',
      apiKeyHealthCheckAllResult: '巡检完成：已检测 {checked}，有效 {valid}',
      apiKeyHealthCheckAllResultWithIssues: '巡检完成：已检测 {checked}，有效 {valid}，自动禁用 {invalid_disabled}，失败 {failed}',
      ...
      oauth: {
        ...
        grok: {
          title: 'Grok / xAI 账户授权',
          followSteps: '请按照以下步骤完成 Grok / xAI 账户授权：',
          step1GenerateUrl: '生成授权链接',
          generateAuthUrl: '生成授权链接',
          step2OpenUrl: '在浏览器中打开链接并完成授权',
          openUrlDesc: '请在新标签页中打开授权链接，登录您的 xAI 账户并授权。',
          step3EnterCode: '输入授权链接或 Code',
          authCodeDesc: '授权完成后，复制回调链接或 code 参数并粘贴到下方。',
          authCode: '授权链接或 Code',
    ...
    ops: {
      ...
      alertRules: {
        ...
        metricDescriptions: {
          ...
          proxyExpiredCount: '当前已标记为过期的代理数量。',
          proxyExpiringSoonCount: '当前仍 active 但会在各自提醒天数内过期的代理数量。'
        },
        hints: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        glmZCodeStrongMimic: 'GLM ZCode 重度伪装',
        glmZCodeStrongMimicHint: '官方 GLM Anthropic 直连默认会做轻度 ZCode 头伪装；开启后额外加入 ZCode 版本、平台、系统等指纹头。',
        glmZCodeStrongMimicNote: '默认关闭，仅对 open.bigmodel.cn / api.z.ai 官方直连生效；自定义中转站不会改写成 ZCode。',
        openaiCyberSafetyRetry: 'OpenAI 网络安全标识换 Key 重试',
        openaiCyberSafetyRetryHint: '命中 OpenAI “possible cybersecurity risk / Trusted Access for Cyber” 响应时，不把该响应透传给客户端，改为换 OpenAI 账号重试。',
        openaiCyberSafetyRetryNote: '默认关闭；开启后单次请求最多换 Key 重试 3 次，仍失败则返回通用上游错误。',
        openaiGPT56SolDefaultMax: 'GPT-5.6 Sol 默认 Max 推理',
        openaiGPT56SolDefaultMaxHint: '当客户端请求 gpt-5.6-sol 但未显式传 reasoning.effort / reasoning_effort 时，自动按 max 推理强度转发并写入用量记录。',
        openaiGPT56SolDefaultMaxNote: '默认关闭；仅在确认你的客户端 UI 选择 Max 但请求体不携带推理字段时开启。',
        ...
        rewriteMessageCacheControl: '消息 cache_control 改写',
        rewriteMessageCacheControlHint: '允许网关主动整理 messages 中的 cache_control 断点。关闭时保留客户端原始消息缓存控制。',
        rewriteMessageCacheControlNote: '默认关闭。自用场景建议仅在确认需要官方式缓存断点改写时开启。',
      },
      webSearchEmulation: {
        title: 'Web Search 模拟',
