...
func registerOpsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	ops := admin.Group("/ops")
	{
		...
		ops.GET("/debug-traces", h.Admin.Ops.ListDebugTraces)
		ops.GET("/debug-traces/:id", h.Admin.Ops.GetDebugTrace)
...
func registerDashboardRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	dashboard := admin.Group("/dashboard")
	{
		...
		dashboard.GET("/projects", h.Admin.Dashboard.GetProjectStats)
		dashboard.GET("/insights", h.Admin.Dashboard.GetUsageInsights)
		dashboard.GET("/team-insights", h.Admin.Dashboard.GetTeamUsageInsights)
		dashboard.GET("/hourly-activity", h.Admin.Dashboard.GetHourlyActivity)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/pool-map", h.Admin.Account.GetPoolMap)
...
func registerGrokOAuthRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	grok := admin.Group("/grok")
	{
		...
		grok.POST("/oauth/import-refresh-tokens", h.Admin.GrokOAuth.ImportRefreshTokens)
		...
		grok.POST("/accounts/batch-probe-quota", h.Admin.GrokOAuth.BatchProbeQuota)
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.GET("/claude-code-fingerprints/drift", h.Admin.Setting.GetClaudeCodeFingerprintDrift)
		adminSettings.GET("/claude-code-fingerprints/lab-diagnosis", h.Admin.Setting.GetClaudeCodeFingerprintLabDiagnosis)
...
func registerUsageRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	usage := admin.Group("/usage")
	{
		...
		usage.GET("/:id/replay-package", h.Admin.Usage.GetReplayPackage)
	}
}
