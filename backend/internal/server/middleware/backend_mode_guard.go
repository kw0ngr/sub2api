...
// It allows the minimal auth surface admins still need, including OAuth callbacks
// and pending continuations. Handler-level checks still forbid self-service signup.
