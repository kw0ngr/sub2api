...
func (m *sessionWindowMockRepo) UpdateSessionWindowEnd(_ context.Context, id int64, end time.Time) error {
	m.sessionWindowCalls = append(m.sessionWindowCalls, swCall{ID: id, End: &end})
	return nil
}
...
func (m *sessionWindowMockRepo) FindByAPIKey(context.Context, string, string, string) (*Account, error) {
	panic("unexpected")
}
