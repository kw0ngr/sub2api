...
var upstreamModelNotFoundKeywords = []string{"model not found", "unknown model", "model_not_found"}
...
func isUpstreamModelNotFoundError(statusCode int, body []byte) bool {
	...
	// DeepSeek-compatible upstreams return the compact form `model: <id>`.
	return strings.HasPrefix(message, "model:") && strings.TrimSpace(strings.TrimPrefix(message, "model:")) != ""
}
