...
func (s *PricingService) matchByModelFamily(model string) *LiteLLMModelPricing {
	...
	families := []modelFamily{
		{name: "opus-4.8", match: []string{"claude-opus-4-8", "claude-opus-4.8"}, pricing: []string{"claude-opus-4-8", "claude-opus-4.8", "claude-opus-4-7", "claude-opus-4.7", "claude-opus-4-6"}},
